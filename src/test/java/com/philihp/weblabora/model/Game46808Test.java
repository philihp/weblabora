...
public class Game46808Test {
  ...
  public void setUp() throws Exception {
    ...
    MoveProcessor.processMove(board, "use LR3");
    MoveProcessor.processMove(board, "commit");
    MoveProcessor.processMove(board, "work_contract I03 Pn");
    ...
    MoveProcessor.processMove(board, "commit");
    MoveProcessor.processMove(board, "work_contract G13 Wh");
    MoveProcessor.processMove(board, "with LAYBROTHER");
    MoveProcessor.processMove(board, "use G13 PnPn");
    MoveProcessor.processMove(board, "commit");
    MoveProcessor.processMove(board, "fell_trees 1 2 Jo");
    MoveProcessor.processMove(board, "commit");
    ...
    MoveProcessor.processMove(board, "use LW3");
    MoveProcessor.processMove(board, "commit");
    MoveProcessor.processMove(board, "work_contract G07 Wh");
    MoveProcessor.processMove(board, "with LAYBROTHER");
    MoveProcessor.processMove(board, "use G07 PtPtPtPtPt");
    MoveProcessor.processMove(board, "commit");
    ...
    MoveProcessor.processMove(board, "commit");
    MoveProcessor.processMove(board, "work_contract I08 PnPn");
    MoveProcessor.processMove(board, "with LAYBROTHER");
    ...
    MoveProcessor.processMove(board, "commit");
    MoveProcessor.processMove(board, "work_contract I27 PnPn");
    MoveProcessor.processMove(board, "with LAYBROTHER");
